...
namespace FF {
    ...
    bool InstancingManager::init(const Wrapper::Device::Ptr& device, uint32_t instancingCount, uint32_t frameCount) {
        ...
        mBufferPosAngle = Wrapper::Buffer::createStorageBuffer(mDevice, sizeof(glm::vec4) * mInstancingCount, mPositionsAngles.data(), true);
        ...
        for (uint32_t i = 0; i < frameCount; ++i) {
            ...
            mBufferMatrices[i] = Wrapper::Buffer::createStorageBuffer(mDevice, sizeof(glm::mat4) * mInstancingCount, nullptr, true);
