...
namespace LZ::Renderer {
    ...
    void TransformUniformManager::init(const LZ::Wrapper::Device::Ptr& device, size_t transformCount, const glm::mat4* initialData, int frameCount) {
        
        mDevice = device;

        mTransformParam = LZ::Wrapper::UniformParameter::create();
    ...
    std::vector<LZ::Wrapper::UniformParameter::Ptr> TransformUniformManager::getParams() const {
