...
namespace LZ::Wrapper {
	...
	void CommandBuffer::pushConstants(const VkPipelineLayout layout, VkShaderStageFlags stageFlags, const LZ::Core::PushConstants& pc) {
		
		vkCmdPushConstants(mCommandBuffer, layout, stageFlags, 0, sizeof(LZ::Core::PushConstants), &pc);
	}
